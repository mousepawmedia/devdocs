...
resource for anyone wanting to learn more about Ubuntu servers, and (c) a
way for others to provide feedback on our server architectures.

..  note:: These guides are provided without warranty.

If you find errors, omissions, typos, or other problems, or otherwise want
to make a suggestion, please file a bug report on our Discourse.
